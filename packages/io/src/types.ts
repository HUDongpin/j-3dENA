export type Ena3dExchangeColumnType =
  | "logical"
  | "integer"
  | "double"
  | "character"
...
export type Ena3dExchangeColumn =
  | Ena3dLogicalColumn
  | Ena3dIntegerColumn
  | Ena3dDoubleColumn
...
export const VALIDATED_ENA3D_EXCHANGE_V1: unique symbol = Symbol(
  "@3dena/io/validated-ena3d-exchange-v1",
);
