...
| SERVICE-002 | PostgreSQL/S3 persistent state and objects | `TS_SUCCESSOR_VERIFIED` | `PLANNED` | migrations, encryption/lifecycle, distributed leases/capacity, restart recovery, storage fencing and soak receipts |
