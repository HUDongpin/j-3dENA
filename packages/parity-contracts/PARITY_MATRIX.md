...
This matrix retains V1 compatibility evidence. Longitudinal V2 is governed by
the versioned jENA/3DENA contracts and invariants; rENA rows are historical and
cannot override a V2 value or block its release solely because values differ.
...
|---|---|---|---|
| Frozen V1 compatibility versions | contract v1 plus public successor receipt | `IMPLEMENTED_UNVERIFIED` | retain the independently reviewed historical artifacts without promoting them to a V2 numerical oracle |
| Longitudinal V2 numerical authority | official jENA source, NUMERICS/PROVENANCE digests, vendored tarball receipt and exact peer gate | `IMPLEMENTED_UNVERIFIED` | `jena-js@0.7.0-ona.0` at `90790856f00bdef63dbd27fc3a5b502e8cffe65f` is the sole fit/projection authority; independent review and exact-head CI remain |
...
| public SDK package | local V2 prerelease tarball with declarations/maps/schemas/notices/provenance; Node/strict-TS/Vite/Next smoke; exactly one reviewed external `jena-js@0.7.0-ona.0` peer | `IMPLEMENTED_UNVERIFIED` | clean-checkout reproduction, registry publication, independent public API approval and release gates |
