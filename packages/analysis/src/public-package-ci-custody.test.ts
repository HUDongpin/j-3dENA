...
function fixture() {
  ...
  const artifactReceipt = {
    ...
    package: {
      name: "j-3dena",
      version: "0.2.0-implemented-unverified.9",
      buildId: SOURCE_HEAD,
    },
    tree: {
    ...
    tarball: {
      filename: "j-3dena-0.2.0-implemented-unverified.9.tgz",
      byteLength: tarballBytes.length,
      sha256: tarballSha256,
      integrity: sri512(tarballBytes),
    },
    npmPack: {
      id: "j-3dena@0.2.0-implemented-unverified.9",
      name: "j-3dena",
      version: "0.2.0-implemented-unverified.9",
  ...
  return {
    ...
    tarballArtifact: artifact(
      ...
      "j-3dena-0.2.0-implemented-unverified.9.tgz",
    ),
    receiptArtifact: artifact(
      RECEIPT_ARTIFACT_ID,
      manifest.receipt.sha256,
      "j-3dena-0.2.0-implemented-unverified.9.tgz.artifact-receipt.json",
    ),
    tarballBytes,
    receiptBytes,
  };
