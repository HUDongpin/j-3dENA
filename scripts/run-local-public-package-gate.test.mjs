...
test("phase-aware plan rebuilds source packages but never generated custody bytes", async () => {
  ...
  const inputs = {
    releaseVersion: "0.2.0-implemented-unverified.8",
  ...
  assert.deepEqual(source[2].args, [
    ...
    "--tarball", "/private/tmp/3dena-source-artifact/j-3dena-0.2.0-implemented-unverified.8.tgz",
    "--receipt", "/private/tmp/3dena-source-artifact/j-3dena-0.2.0-implemented-unverified.8.tgz.artifact-receipt.json",
  ]);
  ...
  assert.deepEqual(generated[0].args, [
    "--package", "packages/analysis/dist/package",
    "--tarball", "packages/analysis/dist/j-3dena-0.2.0-implemented-unverified.8.tgz",
    "--receipt", "packages/analysis/dist/j-3dena-0.2.0-implemented-unverified.8.tgz.artifact-receipt.json",
  ]);
});
